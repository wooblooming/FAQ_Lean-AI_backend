        ...
        try:
            ...
            if slug:
                try:
                    store = Store.objects.get(slug=slug)
                    store_id = store.store_id
                    print(f"Found store_id from slug: {store_id}")
                except Store.DoesNotExist:
            ...
            print(f"Generated store directory: {store_dir}")

            # 디렉토리 존재 여부 확인
            if not os.path.exists(store_dir):
                print(f"Directory does not exist. Creating directory: {store_dir}")
...
class FeedDeleteView(APIView):
    ...
    def delete(self, request, *args, **kwargs):
        print("===== FeedDeleteView Debug Start =====")
        ...
        if not image_id or not store_id:
            print("Error: Missing required parameters (id or store_id)")
            return Response({
                'success': False,
        ...
        try:
            ...
            if os.path.exists(file_path):
                print(f"File exists. Deleting file: {file_path}")
            ...
            print("===== FeedDeleteView Debug End =====")
...
class FeedRenameView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if not image_id or not new_name or not store_id:
            print("Error: Missing required parameters (id, name, store_id)")
            return Response(
        ...
        try:
            ...
            if os.path.exists(old_file_path):
                #print("Old file exists. Proceeding to rename.")
                ...
                print("Error: Old file does not exist.")
                return Response(
